...
namespace Blog.Api.Extensions
{
    public static class ContainerExtensions
    {
        ...
        public static void AddUseCases(this IServiceCollection services)
        {
            ...
            services.AddTransient<ISoftDeletePostUsingIntCommand, EfSoftDeletePostCommand>();
            ...
            services.AddTransient<ISoftDeleteTagUsingIntCommand, EfSoftDeleteTagCommand>();
            services.AddTransient<ISoftDeleteCategoryUsingIntCommand, EfSoftDeleteCategoryCommand>();
            services.AddTransient<ISoftDeleteLikeUsingIntCommand, EfSoftDeleteLikeCommand>();
            services.AddTransient<ISoftDeleteCommentUsingIntCommand, EfSoftDeleteCommentCommand>();
            services.AddTransient<ISoftDeleteUserUsingIntCommand, EfSoftDeleteUserCommand>();
