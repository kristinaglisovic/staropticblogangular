...
namespace Blog.Api.Controllers
{
    ...
    public class CommentsController : ControllerBase
    {
        ...
        public CommentsController(UseCaseHandler handler, BlogDbContext context)
        {
            _handler = handler;
            _context = context;
        }
        ...
        [HttpPatch("{id}")]
        public IActionResult Patch(int id, [FromServices] ISoftDeleteCommentUsingIntCommand command)
        {
